...
# from resnet_model import *
from .customize import SPBlock_ori
...
class BASNet(nn.Module):
    def __init__(self, basic_channels=64):
        ...
        self.spblock1 = SPBlock_ori(basic_channels, basic_channels, nn.BatchNorm2d)
        self.spblock2 = SPBlock_ori(basic_channels, basic_channels, nn.BatchNorm2d)
        self.spblock3 = SPBlock_ori(basic_channels*2, basic_channels*2, nn.BatchNorm2d)
        self.spblock4 = SPBlock_ori(basic_channels*2, basic_channels*2, nn.BatchNorm2d)
        self.spblock5 = SPBlock_ori(basic_channels*2, basic_channels*2, nn.BatchNorm2d)
