...
class BASNet(nn.Module):
    def __init__(self,n_channels,n_classes,Add_defocus = True,backbone = 'resnet34'):
        ...
        if self.Add_defocus:
            ...
            self.se6 = SKConv3(basic_channels*8)
            self.se5 = SKConv3(basic_channels*8)
            self.se4 = SKConv3(basic_channels*8)
            self.se3 = SKConv3(basic_channels*4)
            self.se2 = SKConv3(basic_channels*2)
            self.se1 = SKConv3(basic_channels)
        # else:
