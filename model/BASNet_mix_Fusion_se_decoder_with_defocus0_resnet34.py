...
class BASNet(nn.Module):
    def __init__(self,n_channels,n_classes,Add_defocus = True,backbone = 'resnet34'):
        ...
        if self.Add_defocus:
            ...
            self.se6 = SELayer(basic_channels*8)
            self.se5 = SELayer(basic_channels*8)
            self.se4 = SELayer(basic_channels*8)
            self.se3 = SELayer(basic_channels*4)
            self.se2 = SELayer(basic_channels*2)
            self.se1 = SELayer(basic_channels)
        # else:
