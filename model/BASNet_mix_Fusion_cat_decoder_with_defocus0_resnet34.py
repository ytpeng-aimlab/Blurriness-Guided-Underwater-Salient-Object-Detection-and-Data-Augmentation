...
class DefocusNet(nn.Module):
    def __init__(self,n_channels,basic_channels):
        ...
        self.resb5_1 = make_layers(self.backbone,basic_channels)

        self.pool5 = nn.MaxPool2d(2,2,ceil_mode=True)
        self.resb6_1 = make_layers(self.backbone,basic_channels)
        # #stage 1
    ...
    def forward(self, x):
        ...
        enc4p = self.pool4(enc4) # 512, 14, 14

        enc5 = self.resb5_1(enc4p) ####512, 14, 14

        enc5p = self.pool5(enc5) # 8

        enc6 = self.resb6_1(enc5p)
        return x, enc1, enc2, enc3, enc4, enc5, enc6
...
class BASNet(nn.Module):
    def __init__(self,n_channels,n_classes,Add_defocus = True,backbone = 'resnet34'):
        ...
        #stage 6d
        self.conv6d_1 = nn.Conv2d(basic_channels*24,basic_channels*8,3,padding=1) # 16
        ...
        #stage 5d
        self.conv5d_1 = nn.Conv2d(basic_channels*24,basic_channels*8,3,padding=1) # 16
        ...
        self.conv4d_1 = nn.Conv2d(basic_channels*24,basic_channels*8,3,padding=1)
        ...
        self.conv3d_1 = nn.Conv2d(basic_channels*12,basic_channels*4,3,padding=1)
        ...
        self.conv2d_1 = nn.Conv2d(basic_channels*6,basic_channels*2,3,padding=1)
        ...
        self.conv1d_1 = nn.Conv2d(basic_channels*3,basic_channels,3,padding=1)
        ...
        ## -------------Side Output--------------
        self.outconvb = nn.Conv2d(basic_channels*16,1,3,padding=1)
    ...
    def forward(self,x,defocus):
        ...
        if self.Add_defocus:
            defocus0, defocus1, defocus2, defocus3, defocus4, defocus5, defocus6 = self.defocusnet(defocus)#channel: 64, 64 128 256 512
